performance.mark("js-parse-end:environment-054f5aad5dd15bfc.js");
"use strict";
(globalThis.webpackChunk_github_ui_github_ui = globalThis.webpackChunk_github_ui_github_ui || []).push([
  ["85363"], {
    34619(e, t, n) {
      ...
      var r = n(26316);
      let o = r.cg?.document?.head?.querySelector('meta[name="release"]')?.content || "",
    ...
    43420(e, t, n) {
      ...
      }), o.cg?.location.hash === "#b00m" && setTimeout(() => {
        throw Error("b00m")
      }), n(89272);
      var i = n(63371),
        a = n(51189);
      ...
      let l = /\breact-(?:dom|lib|profiling)\b/;
      ...
      document.documentElement.hasAttribute("override-fetch") && window.fetch !== f && (window.fetch = f);
      var m = n(381),
        p = n(41763),
        g = n(66743);
      let y = /-[0-9a-f]{16}\.(js|(?:module\.)?css)$/;
      ...
      if ((0, i.Bb)(), "u" > typeof document) {
        if (o.cg && (o.cg.fetch = async (e, t) => {
            try {
              let n = await s(e, t);
              return c({
                input: e,
          ...
          Node.prototype.removeChild = function(t) {
            try {
              ...
              if (e instanceof Error && u(e.stack)) return t;
              throw e
            }
          }
        }
        ...
        function() {
          ...
          t.observe({
            ...
            setTimeout(() => {
              let n;
              t.disconnect();
              let r = (n = performance.getEntriesByType("paint").find(e => "first-paint" === e.name), n?.startTime),
                o = new Map([
                  ["css-blocking", S()],
                  ["css-deferred", S()],
                  ["js-blocking", S()],
              ...
              for (let t of e) {
                let e = function(e, t) {
                  ...
                  let n = e.responseEnd <= t;
                  return "css" === e.resourceType ? n ? "css-blocking" : "css-deferred" : n ? "js-blocking" : "js-deferred"
                }(t, r);
                if (!e) continue;
                let n = o.get(e);
                n && function(e, t) {
                  var n;
                  let r = (n = t.name).split("/").pop() ?? n,
                    o = w(t),
                    i = Math.round(100 * (w(t) ? 0 : t.responseEnd - t.responseStart)) / 100,
                    a = t.decodedBodySize || 0,
                    s = t.encodedBodySize || 0;
                  e.count++, e.totalSizeBytes += a, e.totalCompressedSizeBytes += s, !o && (t.responseStart < e.earliestResponseStart && (e.earliestResponseStart = t.responseStart), t.responseEnd > e.latestResponseEnd && (e.latestResponseEnd = t.responseEnd), i > e.maxAssetDownloadMs && (e.maxAssetDownloadMs = i)), o && e.cachedCount++, e.entries.push({
                    name: r,
                    nameWithoutHash: r.replace(y, ".$1"),
                    cached: o,
                    downloadMs: i,
                    sizeBytes: a,
                    compressedSizeBytes: s
                  })
                }(n, t)
              }
              for (let [e, t] of o) ! function(e, t, n) {
                if (0 === n.count) return;
                n.earliestResponseStart !== 1 / 0 && n.latestResponseEnd !== -1 / 0 && (n.wallTimeMs = Math.round((n.latestResponseEnd - n.earliestResponseStart) * 100) / 100);
                let r = function(e) {
                  ...
                  let t = [],
                    ...
                    r = 2;
                  for (let o of e) {
                    let e = JSON.stringify(o).length + 2;
                    n.length > 0 && r + e > 524288 && (t.push(n), n = [], r = 2), n.push(o), r += e
                  }
                  return n.length > 0 && t.push(n), t
                }(n.entries);
                for (let o of r)(0, g.BI)(e, {
                  category: t,
                  count: n.count,
                  totalSizeBytes: n.totalSizeBytes,
                  totalCompressedSizeBytes: n.totalCompressedSizeBytes,
                  wallTimeMs: n.wallTimeMs,
                  maxAssetDownloadMs: n.maxAssetDownloadMs,
                  cachedCount: n.cachedCount,
                  entries: JSON.stringify(o),
                  chunkTotal: r.length
                }, {
                  batched: !0
                })
    ...
    25649(e, t, n) {
      ...
      let m = !1,
        p = 0,
        g = Date.now(),
        y = new Set(["AbortError", "AuthSessionExpiredError", "TypeError", "RateLimitError", "NotAcceptableError", "SecFetchHeaderError", "FetchNetworkError", "NoiseError", "ServiceUnavailableError"]),
        w = new Set(["Failed to fetch", "NetworkError when attempting to fetch resource.", "Unable to perform this operation. Please try again later."]);
      ...
      function S(e, t = {}) {
        ...
        e.name && ("AbortError" === e.name || "RateLimitError" === e.name || "NotAcceptableError" === e.name || "SecFetchHeaderError" === e.name || "FetchNetworkError" === e.name || "NoiseError" === e.name || "ServiceUnavailableError" === e.name && q() || y.has(e.name) && w.has(e.message) || e.name.startsWith("ApiError") && w.has(e.message)) || v(b({
          type: e.name,
          value: e.message,
          stacktrace: c(e),
      ...
      async function v(e) {
        let t;
        if (t = Date.now() - g > 2592e5, !(!A && !m && p < 10 && (r ??= (0, i.TT)() && function() {
            let e = d.cg?.history,
              t = d.cg?.location;
            if (!e || !t) return !1;
            try {
        ...
        let n = document.head?.querySelector('meta[name="browser-errors-url"]')?.content;
        if (n) {
      ...
      function b(e, t = {}) {
        ...
        return r.reactAppName || (r.reactAppName = function(e) {
          ...
          error: e,
          sanitizedUrl: `${window.location.protocol}//${window.location.host}${((n=l("meta[name=analytics-location]"))?n.content:window.location.pathname)+function(){let e=l("meta[name=analytics-location-query-strip]"),t="";e||(t=window.location.search);let n=l("meta[name=analytics-location-params]");for(let e of(n&&(t+=(t?"&":"?")+n.content),document.querySelectorAll("meta[name=analytics-param-rename]"))){let n=e.content.split(":",2);t=t.replace(RegExp(`(^|[?&])${n[0]}($|=)`,"g"),`$1${n[1]}$2`)}return t}()}` || window.location.href,
      ...
      let A = !1;
      d.cg?.addEventListener("pageshow", () => A = !1), d.cg?.addEventListener("pagehide", () => A = !0), "function" == typeof BroadcastChannel && new BroadcastChannel("shared-worker-error").addEventListener("message", e => {
        S(e.data.error)
      });
      let C = ["Object Not Found Matching Id", "Not implemented on this platform", "provider because it's not your default extension"],
        T = [
          ["react-app", "app-name"],
    ...
    381(e, t, n) {
      ...
      function c(e) {
        let t = {};
        return void 0 !== e && (t["X-Fetch-Nonce-To-Validate"] = e), void 0 === e ? t[o] = s() : i.has(e) ? t[o] = e : t[o] = Array.from(i).join(","), t
      }

      function l() {
        let e = r.XC?.head?.querySelector('meta[name="fetch-nonce"]')?.content || "";
        e && a(e)
      }
    },
    66743(e, t, n) {
      ...
      let l = "font-weight: bold; font-size: 12px;",
        ...
        h = new Set(["react", "reactApp", "reactPartials", "featureFlags", "ssr", "controller", "action", "routePattern", "cpu", "domNodes", "previousDomNodes", "navigationId"]);
      ...
      let {
        getItem: m
      } = (0, a.A)("localStorage"), p = "dimension_", g = ["utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content", "scid"];
      ...
      function S(e) {
        let t = y("octolytics")?.baseContext ?? {};
        if (t)
          for (let [e, n] of(delete t.app_id, delete t.event_url, delete t.host, Object.entries(t))) e.startsWith(p) && (t[e.replace(p, "")] = n, delete t[e]);
        let n = s.XC?.querySelector("meta[name=visitor-payload]");
        for (let [e, r] of(n && Object.assign(t, JSON.parse(atob(n.content))), new URLSearchParams(window.location.search))) g.includes(e.toLowerCase()) && (t[e] = r);
      ...
      function E(e, t = {}, {
        ...
        for (let [e, n] of Object.entries(t)) null != n && (i[e] = `${n}`);
        if (r) {
          let t = e || "unknown",
            o = S(i);
          n ? r.sendBatchedEvent(t, S(i)) : r.sendEvent(t, S(i)), "true" === m("stats-dev-logger") && function(e, t = {}) {
            let n, r = [];
            for (let [e, n] of Object.entries(t)) u.has(e) || r.push([e, f(n)]);
            let o = void 0 !== t.value ? ` ${"number"==typeof(n=f(t.value))?String(Math.round(n)):String(n)}` : "";
            console.groupCollapsed(`%cevent%c ${e}${o}`, "background: #8957e5; color: #fff; padding: 2px 6px; border-radius: 3px; font-weight: bold; font-size: 11px;", l), "web-vital" === e ? function(e) {
              for (let [t, n] of e) d.has(t) ? (console.log(`%c${t}`, l), console.table(n)) : h.has(t) || console.log(`${t}:`, n)
      ...
      w && (delete w.baseContext, w.idleTimeout = 5e3, w.maxBatchSize = 50, r = new i.s(w))
    },
    41763(e, t, n) {
      n.d(t, {
        Ex: () => a,
        ...
        return {
          getItem: function(e, t = Date.now()) {
            try {
              ...
              if (!n) return null;
              let r = `${e}:expiry`,
                o = Number(l.getItem(r));
              if (o && t > o) return h(e), h(r), d("SAFE_STORAGE_VALUE_EXPIRED"), null;
              return d("SAFE_STORAGE_VALUE_WITHIN_TTL"), s(n)
            } catch {
              return null
            }
          },
          setItem: function(e, n, r = Date.now()) {
            try {
              if (l.setItem(e, c(n)), t.ttl) {
                let n = `${e}:expiry`,
                  o = r + t.ttl;
                l.setItem(n, o.toString())
              }
            } catch (e) {
    ...
    97398(e, t, n) {
      ...
      let a = "reload",
        ...
        h = "soft-nav:latest-mechanism";

      function f() {
        (0, r.SO)(u, "0"), (0, r.Ai)(l), (0, r.Ai)(s), (0, r.Ai)(c), (0, r.Ai)(d), (0, r.Ai)(h)
      }
      ...
      function v(e) {
        (0, r.SO)(s, e || a), (0, r.SO)(c, window.location.href)
      }
      ...
      if (void 0 !== globalThis.Element && void 0 !== globalThis.Document && (!("ariaNotify" in Element.prototype) || !("ariaNotify" in Document.prototype))) {
        ...
        class i extends HTMLElement {
          ...
          handleMessage(e = null, n = "") {
            t === e && (this.#o.textContent == n && (n += "\xa0"), this.#o.textContent = n)
          }
        }
        customElements.define(n, i), "ariaNotify" in Element.prototype || (Element.prototype.ariaNotify = function(e, {
          priority: t = "normal"
        } = {}) {
          o.enqueue(new r({
            element: this,
  ...
  function(e) {
    e.O(0, ["28839", "34646", "85924"], function() {
      return e(e.s = 43420)
    }), e.O()
  }
]);
//# sourceMappingURL=environment-054f5aad5dd15bfc-47c24347fd04bf2c.js.map