performance.mark("js-parse-end:38302-841b0fa97d5950a1.js");
"use strict";
(globalThis.webpackChunk_github_ui_github_ui = globalThis.webpackChunk_github_ui_github_ui || []).push([
  ["38302"], {
    21744(e, t, n) {
      ...
      function d(e, t) {
        var n, o, r, i, a, s, c = (e = e.slice(0).concat(e.default)).length,
          l = t,
          d = [];
        do
          if (u.exec(""), (r = u.exec(l)) && (l = r[3], r[2] || !l)) {
            for (n = 0; n < c; n++)
      ...
      o.prototype.logDefaultIndexUsed = function() {}, o.prototype.add = function(e, t) {
        var n, o, i, a, s, c, l, u, f = this.activeIndexes,
          h = this.selectors,
        ...
        if ("string" == typeof e) {
          for (o = 0, p[(n = {
              ...
              selector: e,
              data: t
            }).id] = n, l = d(this.indexes, e); o < l.length; o++) a = (u = l[o]).key, (s = function(e, t) {
            var n, o, r;
            for (n = 0, o = e.length; n < o; n++)
              if (r = e[n], t.isPrototypeOf(r)) return r
          }(f, i = u.index)) || ((s = Object.create(i)).map = new r, f.push(s)), i === this.indexes.default && this.logDefaultIndexUsed(n), (c = s.map.get(a)) || (c = [], s.map.set(a, c)), c.push(n);
          this.size++, h.push(e)
        }
      }, o.prototype.remove = function(e, t) {
        if ("string" == typeof e) {
          var n, o, r, i, a, s, c, l, u = this.activeIndexes,
            f = this.selectors = [],
          ...
          for (r = 0, n = d(this.indexes, e); r < n.length; r++)
            for (o = n[r], i = u.length; i--;)
              if (s = u[i], o.index.isPrototypeOf(s)) {
                if (c = s.map.get(o.key))
                  for (a = c.length; a--;)(l = c[a]).selector === e && (g || l.data === t) && (c.splice(a, 1), p[l.id] = !0);
                break
        ...
        for (t = 0, o = d.length; t < o; t++)
          for (n = 0, i = d[t], r = (a = this.matches(i)).length; n < r; n++) l[(c = a[n]).id] ? s = l[c.id] : (s = {
            id: c.id,
            selector: c.selector,
            data: c.data,
            elements: []
        ...
        if (!e) return [];
        var t, n, o, r, i, a, s, c, l, u, d, h = this.activeIndexes,
          p = {},
          g = [];
        for (t = 0, r = h.length; t < r; t++)
          if (c = (s = h[t]).element(e)) {
            for (n = 0, i = c.length; n < i; n++)
              if (l = s.map.get(c[n]))
                for (o = 0, a = l.length; o < a; o++) !p[d = (u = l[o]).id] && this.matchesSelector(e, u.selector) && (p[d] = !0, g.push(u))
          } return g.sort(f)
      };
      var h = {},
        p = {},
      ...
      function S(e) {
        if (function(e) {
          ...
          if (t) {
            ...
            if (n.length) {
              w(e, "stopPropagation", v), w(e, "stopImmediatePropagation", A), x(e, k);
      ...
      function E(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
          ...
          a = i ? p : h,
          s = a[e];
        s || (s = new o, a[e] = s, document.addEventListener(e, S, i)), s.add(t, n)
      }
    ...
    94571(e, t, n) {
      ...
      class O {
        constructor(e, t) {
          ...
          Object.defineProperty(e, "observedAttributes", {
            ...
            function(e) {
              ...
              Object.defineProperty(e, "observedAttributes", {
                configurable: !0,
                get: () => [...P(e.prototype, p)].map(o).concat(t),
                set(e) {
                  t = e
                }
              })
        ...
        connectedCallback(e, t) {
          ...
          (m(e), r.add(e), e.shadowRoot && (s(o = e.shadowRoot), a(o)), s(e), a(e.ownerDocument), t?.call(e), e.shadowRoot) && (s(n = e.shadowRoot), a(n), E(e.shadowRoot))
        }
      ...
      function M(e, t) {
        P(e, "target").add(t), Object.defineProperty(e, t, {
          configurable: !0,
          get() {
            return d(this, t)
          }
      ...
      function $(e, t) {
        P(e, "targets").add(t), Object.defineProperty(e, t, {
          configurable: !0,
          get() {
...
//# sourceMappingURL=38302-841b0fa97d5950a1-955467e30d405b49.js.map