      ...
      class I {
        ...
        interpolate(e, t, n, r) {
          ...
          const u = e => {
            ...
            return this.format(A(t, s, o, this.options.keySeparator, this.options.ignoreJSONStructure), a, n, {
              ...r,
              ...t,
              interpolationkey: o
            })
        ...
        nest(e, t) {
          ...
          for (; n = this.nestingRegexp.exec(e);) {
            ...
            "string" != typeof r && (r = l(r)), r || (this.logger.warn(`missed to resolve ${n[1]} for nesting ${e}`), r = ""), c && (r = s.reduce((e, t) => this.format(e, t, o.lng, {
              ...o,
              ...
              methods: {
                ...
                convertHTML: function(e) {
                  ...
                  return n && n.length > 0 && n.forEach((function(t) {
                    var n, r = t.indexOf("_"),
                      i = t.lastIndexOf("_");
                    n = t.substring(0, r) + "<i>" + t.substring(r + 1, i) + "</i>" + t.substring(i + 1, t.length), e = e.replace(t, n)
                  })), t && t.length > 0 && t.forEach((function(t) {
                    var n, r = t.indexOf("*"),
                      i = t.lastIndexOf("*");
                    n = t.substring(0, r) + "<b>" + t.substring(r + 1, i) + "</b>" + t.substring(i + 1, t.length), e = e.replace(t, n)
                  })), e = e.replace(/:tawky:/gi, '<img src="'.concat(this.imageUrl, '" alt="Tawk.to" style="width: 16px; height: 16px;">'))
                }
              }
            }, (function() {
              var e = this,
