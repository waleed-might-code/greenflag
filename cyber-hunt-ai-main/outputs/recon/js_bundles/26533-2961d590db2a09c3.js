performance.mark("js-parse-end:26533-2961d590db2a09c3.js");
"use strict";
(globalThis.webpackChunk_github_ui_github_ui = globalThis.webpackChunk_github_ui_github_ui || []).push([
  ["26533"], {
    7332(e, t, i) {
      ...
      var s = HTMLFormElement.prototype;

      function r(e, t, i) {
        throw new e("Failed to execute 'requestSubmit' on 'HTMLFormElement': " + t + ".", i)
      }
      "function" != typeof s.requestSubmit && (s.requestSubmit = function(e) {
        var t, i;
        e ? (t = e, i = this, t instanceof HTMLElement || r(TypeError, "parameter 1 is not of type 'HTMLElement'"), "submit" == t.type || r(TypeError, "The specified element is not a submit button"), t.form == i || r(DOMException, "The specified element is not owned by this form element", "NotFoundError"), e.click()) : ((e = document.createElement("input")).type = "submit", e.hidden = !0, this.appendChild(e), e.click(), this.removeChild(e))
      });
      let n = new WeakMap;

      function o(e) {
        var t;
        let i, s, r = (null == (s = (i = (t = e.target) instanceof Element ? t : t instanceof Node ? t.parentElement : null) ? i.closest("input, button") : null) ? void 0 : s.type) == "submit" ? s : null;
      ...
      let a = null,
        l = null != (ek = null == (eF = globalThis.trustedTypes) ? void 0 : eF.emptyHTML) ? ek : "";
      (eE = eI || (eI = {})).eager = "eager", eE.lazy = "lazy";
      class h extends HTMLElement {
        ...
        get loading() {
          return "lazy" === (this.getAttribute("loading") || "").toLowerCase() ? eI.lazy : eI.eager
        }
        set loading(e) {
      ...
      function f(e) {
        if ("false" == e.getAttribute("data-turbo-eval")) return e;
        {
          let t = document.createElement("script"),
            i = T("csp-nonce");
          return i && (t.nonce = i), null !== e.textContent && (null !== a ? t.textContent = a.createScript(e.textContent) : t.textContent = e.textContent), t.async = !1,
            function(e, t) {
              for (let {
                  name: i,
                  value: s
      ...
      function S(e, ...t) {
        var i, s;
        let r = (i = e, s = t, i.reduce((e, t, i) => e + t + (void 0 == s[i] ? "" : s[i]), "")).replace(/^\n/, "").split("\n"),
          n = r[0].match(/^\s+/),
          o = n ? n[0].length : 0;
      ...
      function T(e) {
        let t = C(e);
        return t && t.content
      }(ey = eM || (eM = {}))[ey.get = 0] = "get", ey[ey.post = 1] = "post", ey[ey.put = 2] = "put", ey[ey.patch = 3] = "patch", ey[ey.delete = 4] = "delete";
      class P {
        constructor(e, t, i, s = new URLSearchParams, r = null) {
          this.abortController = new AbortController, this.resolveRequestPromise = e => {}, this.delegate = e, this.method = t, this.headers = this.defaultHeaders, this.body = s, this.url = i, this.target = r
        }
        get location() {
          return this.url
        }
        ...
        async perform() {
          ...
          null == (t = (e = this.delegate).prepareHeadersForRequest) || t.call(e, this.headers, this), await this.allowRequestToBeIntercepted(i);
          try {
        ...
        get fetchOptions() {
          var e;
          return {
            method: eM[this.method].toUpperCase(),
      ...
      k.contentType = "text/vnd.turbo-stream.html", (eL = eH || (eH = {}))[eL.initialized = 0] = "initialized", eL[eL.requesting = 1] = "requesting", eL[eL.waiting = 2] = "waiting", eL[eL.receiving = 3] = "receiving", eL[eL.stopping = 4] = "stopping", eL[eL.stopped = 5] = "stopped", (eR = eq || (eq = {})).urlEncoded = "application/x-www-form-urlencoded", eR.multipart = "multipart/form-data", eR.plain = "text/plain";
      class I {
        constructor(e, t, i, s = !1) {
          this.state = eH.initialized, this.delegate = e, this.formElement = t, this.submitter = i, this.formData = function(e, t) {
            let i = new FormData(e),
              s = null == t ? void 0 : t.getAttribute("name"),
              r = null == t ? void 0 : t.getAttribute("value");
            return s && i.append(s, r || ""), i
          }(t, i), this.location = c(this.action), this.method == eM.get && function(e, t) {
            let i = new URLSearchParams;
            for (let [e, s] of t) s instanceof File || i.append(e, s);
            e.search = i.toString()
          }(this.location, [...this.body.entries()]), this.fetchRequest = new P(this, this.method, this.location, this.body, this.formElement), this.mustRedirect = s
        }
        ...
        get method() {
          ...
          }(((null == (e = this.submitter) ? void 0 : e.getAttribute("formmethod")) || this.formElement.getAttribute("method") || "").toLowerCase()) || eM.get
        }
        get action() {
          var e;
        ...
        get body() {
          return this.enctype == eq.urlEncoded || this.method == eM.get ? new URLSearchParams(this.stringFormData) : this.formData
        }
        get enctype() {
          var e;
        ...
        get stringFormData() {
          return [...this.formData].reduce((e, [t, i]) => e.concat("string" == typeof i ? [
            [t, i]
          ] : []), [])
        }
        async start() {
          let {
            initialized: e,
            requesting: t
          } = eH, i = y("data-turbo-confirm", this.submitter, this.formElement);
          if (("string" != typeof i || await I.confirmMethod(i, this.formElement, this.submitter)) && this.state == e) return this.state = t, this.fetchRequest.perform()
        }
        stop() {
          let {
            stopping: e,
        ...
        requestStarted(e) {
          var t;
          this.state = eH.waiting, null == (t = this.submitter) || t.setAttribute("disabled", ""), v("turbo:submit-start", {
        ...
        requestFinished(e) {
          var t;
          this.state = eH.stopped, null == (t = this.submitter) || t.removeAttribute("disabled"), v("turbo:submit-end", {
            target: this.formElement,
      ...
      class M {
        ...
        getPermanentElementMapForSnapshot(e) {
          ...
          for (let i of this.permanentElements) {
            let {
              id: s
            } = i, r = e.getPermanentElementById(s);
            r && (t[s] = [i, r])
          }
          return t
        }
        ...
        constructor(e, t) {
          this.started = !1, this.submitCaptured = () => {
            ...
            if (!e.defaultPrevented) {
              var t, i;
              let s = e.target instanceof HTMLFormElement ? e.target : void 0,
                r = e.submitter || void 0;
              s && (t = s, "dialog" != ((null == (i = r) ? void 0 : i.getAttribute("formmethod")) || t.getAttribute("method"))) && function(e, t) {
                let i = (null == t ? void 0 : t.getAttribute("formtarget")) || e.target;
                for (let e of document.getElementsByName(i))
                  if (e instanceof HTMLIFrameElement) return !1;
                return !0
              }(s, r) && this.delegate.willSubmitForm(s, r) && (e.preventDefault(), e.stopImmediatePropagation(), this.delegate.formSubmitted(s, r))
            }
      ...
      class O {
        ...
        async render(e) {
          ...
          if (i) try {
            ...
            this.delegate.allowsImmediateRender(s, r) || await i, await this.renderSnapshot(e), this.delegate.viewRenderedSnapshot(s, t), this.delegate.preloadOnLoadLinksForView(this.element), this.finishRenderingSnapshot(e)
          } finally {
          ...
          this.started = !1, this.clickCaptured = () => {
            ...
            if (e instanceof MouseEvent && this.clickEventIsSignificant(e)) {
              ...
              if (i && function(e) {
                ...
                this.delegate.willFollowLinkToLocation(i, t, e) && (e.preventDefault(), this.delegate.followedLinkToLocation(i, t))
              }
            }
          }, this.delegate = e, this.eventTarget = t
        }
      ...
      class W {
        ...
        followedLinkToLocation(e, t) {
          ...
          s.setAttribute("data-turbo", "true"), s.setAttribute("action", i), s.setAttribute("hidden", "");
          ...
          a && s.setAttribute("data-turbo-confirm", a), e.hasAttribute("data-turbo-stream") && s.setAttribute("data-turbo-stream", ""), this.delegate.submittedFormLinkToLocation(e, t, s), document.body.appendChild(s), s.addEventListener("turbo:submit-end", () => s.remove(), {
            once: !0
      ...
      class x {
        ...
        replaceNewPermanentElementWithPlaceholder(e) {
          var t;
          let i, s = (t = e, (i = document.createElement("meta")).setAttribute("name", "turbo-permanent-placeholder"), i.setAttribute("content", t.id), i);
          e.replaceWith(s)
        }
      ...
      class U {
        constructor(e, t, i, s, r = !0) {
          this.activeElement = null, this.currentSnapshot = e, this.newSnapshot = t, this.isPreview = s, this.willRender = r, this.renderElement = i, this.promise = new Promise((e, t) => this.resolvingFunctions = {
            resolve: e,
            reject: t
          })
        }
      ...
      class _ extends U {
        ...
        static renderElement(e, t) {
          ...
          let r = null == (i = t.ownerDocument) ? void 0 : i.createRange();
        ...
        scrollFrameIntoView() {
          if (this.currentElement.autoscroll || this.newElement.autoscroll) {
            var e, t;
            let i = this.currentElement.firstElementChild,
              s = "end" == (e = this.currentElement.getAttribute("data-autoscroll-block")) || "start" == e || "center" == e || "nearest" == e ? e : "end",
              r = "auto" == (t = this.currentElement.getAttribute("data-autoscroll-behavior")) || "smooth" == t ? t : "auto";
            if (i) return i.scrollIntoView({
              block: s,
              behavior: r
            }), !0
          }
              ...
              if ("false" == e.getAttribute("data-turbo-eval")) return e;
              {
                ...
                return function(e, t) {
                  for (let {
                    ...
                    of t.attributes) e.setAttribute(i, s)
                }(t, e), t
              }
            }(e);
            e.replaceWith(t)
    ...
    `
      ...
      class $ extends M {
        constructor() {
          super(...arguments), this.detailsByOuterHTML = this.children.filter(e => "noscript" != e.localName).map(e => {
            ...
            let r, {
              ...
              o = n in e ? e[n] : {
                type: "script" == (i = t).localName ? "script" : "style" == (r = (s = i).localName) || "link" == r && "stylesheet" == s.getAttribute("rel") ? "stylesheet" : void 0,
        ...
        findMetaElementByName(e) {
          return Object.keys(this.detailsByOuterHTML).reduce((t, i) => {
            ...
            return (s = n, r = e, "meta" == s.localName && s.getAttribute("name") == r) ? n : t
          }, void 0)
        }
      }
      class z extends M {
      ...
      }(eA = eB || (eB = {})).visitStart = "visitStart", eA.requestStart = "requestStart", eA.requestEnd = "requestEnd", eA.visitEnd = "visitEnd", (eC = eO || (eO = {})).initialized = "initialized", eC.started = "started", eC.canceled = "canceled", eC.failed = "failed", eC.completed = "completed";
      let K = {
        action: "advance",
        historyChanged: !1,
        visitCachedSnapshot: () => {},
      ...
      (eT = eV || (eV = {}))[eT.networkFailure = 0] = "networkFailure", eT[eT.timeoutFailure = -1] = "timeoutFailure", eT[eT.contentTypeMismatch = -2] = "contentTypeMismatch";
      class Y {
        constructor(e, t, i, s = {}) {
          this.identifier = E(), this.timingMetrics = {}, this.followedRedirect = !1, this.historyChanged = !1, this.scrolled = !1, this.shouldCacheSnapshot = !0, this.acceptsStreamResponse = !1, this.snapshotCached = !1, this.state = eO.initialized, this.delegate = e, this.location = t, this.restorationIdentifier = i || E();
          const {
            action: r,
            historyChanged: n,
            referrer: o,
        ...
        start() {
          this.state == eO.initialized && (this.recordTimingMetric(eB.visitStart), this.state = eO.started, this.adapter.visitStarted(this), this.delegate.visitStarted(this))
        }
        cancel() {
          this.state == eO.started && (this.request && this.request.cancel(), this.cancelRender(), this.state = eO.canceled)
        }
        complete() {
          this.state == eO.started && (this.recordTimingMetric(eB.visitEnd), this.state = eO.completed, this.followRedirect(), this.followedRedirect || (this.adapter.visitCompleted(this), this.delegate.visitCompleted(this)))
        }
        fail() {
          this.state == eO.started && (this.state = eO.failed, this.adapter.visitFailed(this))
        }
        changeHistory() {
          var e;
        ...
        issueRequest() {
          this.hasPreloadedResponse() ? this.simulateRequest() : this.shouldIssueRequest() && !this.request && (this.request = new P(this, eM.get, this.location), this.request.perform())
        }
        simulateRequest() {
          this.response && (this.startRequest(), this.recordResponse(), this.finishRequest())
        }
        startRequest() {
          this.recordTimingMetric(eB.requestStart), this.adapter.visitRequestStarted(this)
        }
        ...
        finishRequest() {
          this.recordTimingMetric(eB.requestEnd), this.adapter.visitRequestFinished(this)
        }
        loadResponse() {
          if (this.response) {
            let {
        ...
        async requestSucceededWithResponse(e, t) {
          ...
          void 0 == i ? this.recordResponse({
            statusCode: eV.contentTypeMismatch,
            redirected: s
      ...
      class X {
        ...
        visitRequestFailedWithStatusCode(e, t) {
          switch (t) {
            case eV.networkFailure:
            case eV.timeoutFailure:
            case eV.contentTypeMismatch:
              return this.reload({
      ...
      class G {
        ...
        shouldSubmit(e, t) {
          ...
          let s = u(e, t),
            ...
            n = c(null != (i = null == r ? void 0 : r.content) ? i : "/");
        ...
        findFrameElement(e, t) {
          let i = (null == t ? void 0 : t.getAttribute("data-turbo-frame")) || e.getAttribute("data-turbo-frame");
          if (i && "_top" != i) {
      ...
      class Z {
        ...
        update(e, t, i = E()) {
          ...
          }, "", t.href), this.location = t, this.restorationIdentifier = i
        }
      ...
      class ee {
        ...
        startVisit(e, t, i = {}) {
          this.stop(), this.currentVisit = new Y(this, c(e), t, Object.assign({
        ...
        async formSubmissionFailedWithResponse(e, t) {
          let i = await t.responseHTML;
          if (i) {
            let e = z.fromResponse(t.response, i);
        ...
        locationWithActionIsSamePage(e, t) {
          ...
          return "replace" !== t && m(e) === m(this.view.lastRenderedLocation) && ("restore" === t && void 0 === i || null != i && i !== s)
        }
        ...
        getActionForFormSubmission(e) {
          let {
            formElement: t,
            submitter: i
          } = e, s = y("data-turbo-action", i, t);
          return g(s) ? s : "advance"
        }
      }(eP = eN || (eN = {}))[eP.initial = 0] = "initial", eP[eP.loading = 1] = "loading", eP[eP.interactive = 2] = "interactive", eP[eP.complete = 3] = "complete";
      class et {
        constructor(e) {
          this.stage = eN.initial, this.started = !1, this.interpretReadyState = () => {
            let {
              readyState: e
            } = this;
        ...
        start() {
          this.started || (this.stage == eN.initial && (this.stage = eN.loading), document.addEventListener("readystatechange", this.interpretReadyState, !1), addEventListener("pagehide", this.pageWillUnload, !1), this.started = !0)
        }
        stop() {
        ...
        pageIsInteractive() {
          this.stage == eN.loading && (this.stage = eN.interactive, this.delegate.pageBecameInteractive())
        }
        pageIsComplete() {
          this.pageIsInteractive(), this.stage == eN.interactive && (this.stage = eN.complete, this.delegate.pageLoaded())
        }
        get readyState() {
      ...
      class er {
        constructor(e) {
          this.sources = new Set, this.started = !1, this.inspectFetchResponse = e => {
            ...
            let i = function(e) {
              var t;
              let i = null == (t = e.detail) ? void 0 : t.fetchResponse;
              if (i instanceof p) return i
            }(e);
            i && (null != (t = i.contentType) ? t : "").startsWith(k.contentType) && (e.preventDefault(), this.receiveMessageResponse(i))
      ...
      class el extends O {
        ...
        renderPage(e, t = !1, i = !0, s) {
          let r = new eo(this.snapshot, e, eo.renderElement, t, i);
          return r.shouldRender ? null == s || s.changeHistory() : this.forceReloaded = !0, this.render(r)
        }
        renderError(e, t) {
          null == t || t.changeHistory();
          let i = new en(this.snapshot, e, en.renderElement, !1);
      ...
      let ed = {
        ...
        em = new class {
          ...
          visit(e, t = {}) {
            ...
            i instanceof h ? (i.src = e.toString(), i.loaded) : this.navigator.proposeVisit(c(e), t)
          }
          connectStreamSource(e) {
          ...
          locationIsVisitable(e, t) {
            var i, s;
            let r;
            return r = (s = (i = t).origin + i.pathname).endsWith("/") ? s : s + "/", (e.href === c(r).href || e.href.startsWith(r)) && this.isVisitable(e)
          }
          ...
          willFollowLinkToLocation(e, t, i) {
            return this.elementIsNavigatable(e) && this.locationIsVisitable(t, this.snapshot.rootLocation) && this.applicationAllowsFollowingLinkToLocation(e, t, i)
          }
          followedLinkToLocation(e, t) {
          ...
          willSubmitForm(e, t) {
            let i = u(e, t);
            return this.submissionIsNavigatable(e, t) && this.locationIsVisitable(c(i), this.snapshot.rootLocation)
          }
          formSubmitted(e, t) {
          ...
          allowsImmediateRender({
            ...
            return this.view.renderer && s && (this.view.renderer.renderElement = s), !i
          }
          ...
          submissionIsNavigatable(e, t) {
            if ("off" == this.formMode) return !1;
            {
              ...
              return "optin" == this.formMode ? i && null != e.closest('[data-turbo="true"]') : i && this.elementIsNavigatable(e)
            }
          }
        ...
        ep = new class {
          ...
          setCacheControl(e) {
            var t;
            let i;
            (i = C(t = "turbo-cache-control")) || ((i = document.createElement("meta")).setAttribute("name", t), document.head.appendChild(i)), i.setAttribute("content", e)
          }
        }(em),
        {
          navigator: eg
      ...
      var eE, ey, eL, eR, eA, eC, eT, eP, eF, ek, eI, eM, eH, eq, eB, eO, eV, eN, eD = Object.freeze({
        __proto__: null,
        navigator: eg,
        session: em,
        cache: ep,
        ...
        visit: ev,
        connectStreamSource: eb,
        disconnectStreamSource: ew,
      ...
      function ex(e, t) {
        if (e) {
          ...
          if (null != i && null != t && c(i).href == c(t).href) throw Error(`Matching <turbo-frame id="${e.id}"> element has a source URL which references itself`);
      ...
      class eU extends HTMLElement {
        ...
        get duplicateChildren() {
          ...
          let t = this.targetElements.flatMap(e => [...e.children]).filter(e => !!e.id),
            i = [...(null == (e = this.templateContent) ? void 0 : e.children) || []].filter(e => !!e.id).map(e => e.id);
      ...
      class e_ extends HTMLElement {
        ...
        connectedCallback() {
          this.streamSource = this.src.match(/^ws{1,2}:/) ? new WebSocket(this.src) : new EventSource(this.src), eb(this.streamSource)
        }
        disconnectedCallback() {
          this.streamSource && ew(this.streamSource)
        }
        get src() {
          return this.getAttribute("src") || ""
        }
      ...
      h.delegateConstructor = class {
        ...
        connect() {
          this.connected || (this.connected = !0, this.loadingStyle == eI.lazy ? this.appearanceObserver.start() : this.loadSourceURL(), this.formLinkClickObserver.start(), this.linkInterceptor.start(), this.formSubmitObserver.start())
        }
        disconnect() {
        ...
        disabledChanged() {
          this.loadingStyle == eI.eager && this.loadSourceURL()
        }
        sourceURLChanged() {
          !this.isIgnoringChangesTo("src") && (this.element.isConnected && (this.complete = !1), (this.loadingStyle == eI.eager || this.hasBeenLoaded) && this.loadSourceURL())
        }
        sourceURLReloaded() {
          let {
            src: e
        ...
        loadingStyleChanged() {
          this.loadingStyle == eI.lazy ? this.appearanceObserver.start() : (this.appearanceObserver.stop(), this.loadSourceURL())
        }
        async loadSourceURL() {
        ...
        async loadResponse(e) {
          ...
          try {
            ...
            if (t) {
              let i;
              if (null == a) i = w(t).body;
              else {
                let s = a.createHTML(t, e.response);
                i = w(s).body
              }
              let s = await this.extractForeignFrameElement(i);
              if (s) {
                let t = new M(s),
                  i = new _(this, this.view.snapshot, t, _.renderElement, !1, !1);
                this.view.renderPromise && await this.view.renderPromise, this.changeHistory(), await this.view.render(i), this.complete = !0, em.frameRendered(e, this.element), em.frameLoaded(this.element), this.fetchResponseLoaded(e)
        ...
        prepareHeadersForRequest(e, t) {
          var i;
          e["Turbo-Frame"] = this.id, (null == (i = this.currentNavigationElement) ? void 0 : i.hasAttribute("data-turbo-stream")) && t.acceptResponseType(k.contentType)
        }
        requestStarted(e) {
          L(this.element)
        }
        ...
        formSubmissionSucceededWithResponse(e, t) {
          ...
          i.delegate.proposeVisitIfNavigatedWithAction(i, e.formElement, e.submitter), i.delegate.loadResponse(t)
        }
        ...
        async visit(e) {
          let t = new P(this, eM.get, e, new URLSearchParams, this.element);
        ...
        navigateFrame(e, t, i) {
          ...
          this.cancelInFlightNavigation(s), this.pageSnapshot = z.fromElement(s).clone(), s.delegate.proposeVisitIfNavigatedWithAction(s, e, i), this.withCurrentNavigationElement(e, () => {
            s.src = t
          })
        }
        ...
        findFrameElement(e, t) {
          var i;
          return null != (i = eW(y("data-turbo-frame", t, e) || this.element.getAttribute("target"))) ? i : this.element
        }
        async extractForeignFrameElement(e) {
          let t, i = CSS.escape(this.id);
          try {
            if (t = ex(e.querySelector(`turbo-frame#${i}`), this.sourceURL)) return t;
            if (t = ex(e.querySelector(`turbo-frame[src][recurse~=${i}]`), this.sourceURL)) return await t.loaded, await this.extractForeignFrameElement(t)
          } catch (e) {
        ...
        formActionIsVisitable(e, t) {
          let i = u(e, t);
          return em.locationIsVisitable(c(i), this.rootLocation)
        }
        shouldInterceptNavigation(e, t) {
          let i = y("data-turbo-frame", t, e) || this.element.getAttribute("target");
          if (e instanceof HTMLFormElement && !this.formActionIsVisitable(e, t) || !this.enabled || "_top" == i) return !1;
          if (i) {
            let e = eW(i);
      ...
      }, void 0 === customElements.get("turbo-frame") && customElements.define("turbo-frame", h), void 0 === customElements.get("turbo-stream") && customElements.define("turbo-stream", eU), void 0 === customElements.get("turbo-stream-source") && customElements.define("turbo-stream-source", e_), (() => {
      ...
      let ej = ["__reactFiber$", "__reactProps$", "__reactContainer$"]
    }
  }
]);
//# sourceMappingURL=26533-2961d590db2a09c3-c997e5caae3bb661.js.map