performance.mark("js-parse-end:68751-fe5cb40b5547c377.js");
"use strict";
  ...
  ["68751"], {
        ...
        return {
          onFetch: (e, s) => {
            let a = e.options,
              ...
              d = async () => {
                let s = !1,
                  d = (0, i.ZM)(e.options, e.fetchOptions),
                  f = async (t, a, r) => {
                    let n;
                ...
                if (u && o.length) {
                  ...
                  let e = t ?? o.length;
                  do {
                    let t = 0 === c ? h[0] ?? a.initialPageParam : r(a, l);
                    if (c > 0 && null == t) break;
                    l = await f(l, t), c++
                  } while (c < e)
                }
    ...
    36158(t, e, s) {
      ...
      var i = s(26261),
        ...
        n = class extends a.k {
          ...
          #i;
          constructor(t) {
            super(), this.#t = t.client, this.mutationId = t.mutationId, this.#s = t.mutationCache, this.#e = [], this.state = t.state || u(), this.setOptions(t.options), this.scheduleGc()
          }
          setOptions(t) {
          ...
          optionalRemove() {
            this.#e.length || ("pending" === this.state.status ? this.scheduleGc() : this.#s.remove(this))
          }
          continue () {
          ...
          async execute(t) {
            ...
            this.#i = (0, r.II)({
              fn: () => this.options.mutationFn ? this.options.mutationFn(t, s) : Promise.reject(Error("No mutationFn found")),
              onFail: (t, e) => {
                this.#a({
                  type: "failed",
                  failureCount: t,
            ...
            try {
              ...
              return await this.#s.config.onSuccess?.(r, t, this.state.context, this, s), await this.options.onSuccess?.(r, t, this.state.context, s), await this.#s.config.onSettled?.(r, null, this.state.variables, this.state.context, this, s), await this.options.onSettled?.(r, null, t, this.state.context, s), this.#a({
                type: "success",
                data: r
              }), r
            } catch (e) {
              ...
              try {
                await this.#s.config.onSettled?.(void 0, e, this.state.variables, this.state.context, this, s)
              } catch (t) {
                Promise.reject(t)
              }
              try {
    ...
    57678(t, e, s) {
      ...
      var i = s(26261),
        ...
        u = class extends n.Q {
          constructor(t = {}) {
            super(), this.config = t, this.#r = new Set, this.#n = new Map, this.#u = 0
          }
          #r;
          #n;
          #u;
          ...
          resumePausedMutations() {
            ...
            return i.jG.batch(() => Promise.all(t.map(t => t.continue().catch(r.lQ))))
          }
        };
    ...
    2471(t, e, s) {
      ...
      var i = s(24880),
        ...
        u = class extends n.Q {
          constructor(t = {}) {
            super(), this.config = t, this.#o = new Map
          }
          #o;
          build(t, e, s) {
            let r = e.queryKey,
          ...
          add(t) {
            this.#o.has(t.queryHash) || (this.#o.set(t.queryHash, t), this.notify({
              type: "added",
              query: t
            }))
          }
          remove(t) {
            let e = this.#o.get(t.queryHash);
            e && (t.destroy(), e === t && this.#o.delete(t.queryHash), this.notify({
              type: "removed",
              query: t
            }))
          }
    ...
    65490(t, e, s) {
      ...
      var i = s(24880),
        ...
        l = class {
          ...
          #y;
          constructor(t = {}) {
            this.#h = t.queryCache || new a.$, this.#s = t.mutationCache || new r.q, this.#l = t.defaultOptions || {}, this.#c = new Map, this.#d = new Map, this.#f = 0
          }
          mount() {
            this.#f++, 1 === this.#f && (this.#p = n.m.subscribe(async t => {
              t && (await this.resumePausedMutations(), this.#h.onFocus())
            }), this.#y = u.t.subscribe(async t => {
              t && (await this.resumePausedMutations(), this.#h.onOnline())
            }))
          }
          unmount() {
            this.#f--, 0 === this.#f && (this.#p?.(), this.#p = void 0, this.#y?.(), this.#y = void 0)
          }
          isFetching(t) {
          ...
          ensureQueryData(t) {
            let e = this.defaultQueryOptions(t),
              ...
              a = s.state.data;
            return void 0 === a ? this.fetchQuery(t) : (t.revalidateIfStale && s.isStaleByTime((0, i.d2)(e.staleTime, s)) && this.prefetchQuery(e), Promise.resolve(a))
          }
          getQueriesData(t) {
            return this.#h.findAll(t).map(({
              queryKey: t,
              state: e
            }) => [t, e.data])
          }
          setQueryData(t, e, s) {
            let a = this.defaultQueryOptions({
              ...
              n = r?.state.data,
              u = (0, i.Zw)(e, n);
            if (void 0 !== u) return this.#h.build(this, a).setData(u, {
              ...s,
              manual: !0
            })
          }
          setQueriesData(t, e, s) {
            return o.jG.batch(() => this.#h.findAll(t).map(({
              queryKey: t
          ...
          resetQueries(t, e) {
            let s = this.#h;
            return o.jG.batch(() => (s.findAll(t).forEach(t => {
              t.reset()
            }), this.refetchQueries({
              type: "active",
              ...t
          ...
          cancelQueries(t, e = {}) {
            ...
            return Promise.all(o.jG.batch(() => this.#h.findAll(t).map(t => t.cancel(s)))).then(i.lQ).catch(i.lQ)
          }
          invalidateQueries(t, e = {}) {
            return o.jG.batch(() => (this.#h.findAll(t).forEach(t => {
              t.invalidate()
          ...
          refetchQueries(t, e = {}) {
            ...
            return Promise.all(o.jG.batch(() => this.#h.findAll(t).filter(t => !t.isDisabled() && !t.isStatic()).map(t => {
          ...
          fetchInfiniteQuery(t) {
            return t.behavior = (0, h.PL)(t.pages), this.fetchQuery(t)
          }
          prefetchInfiniteQuery(t) {
            return this.fetchInfiniteQuery(t).then(i.lQ).catch(i.lQ)
          }
          ensureInfiniteQueryData(t) {
            return t.behavior = (0, h.PL)(t.pages), this.ensureQueryData(t)
          }
          resumePausedMutations() {
            return u.t.isOnline() ? this.#s.resumePausedMutations() : Promise.resolve()
          }
          getQueryCache() {
            return this.#h
          }
...
//# sourceMappingURL=68751-fe5cb40b5547c377-bbfe7fab6a4dab41.js.map