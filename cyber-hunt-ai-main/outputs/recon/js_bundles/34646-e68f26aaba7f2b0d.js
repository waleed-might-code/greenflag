performance.mark("js-parse-end:34646-e68f26aaba7f2b0d.js");
"use strict";
(globalThis.webpackChunk_github_ui_github_ui = globalThis.webpackChunk_github_ui_github_ui || []).push([
  ["34646"], {
    7753(e, t, a) {
      ...
      function r() {
        return void 0 !== n ? n : n = !("u" < typeof navigator) && (navigator.webdriver || (0, i.S1)(navigator.userAgent))
      }
    },
    14674(e, t, a) {
      let n;
      ...
      var i = a(73537);
      let r = /GitHubSyntheticPerf/i;

      function o() {
        return void 0 !== n ? n : n = !("u" < typeof navigator) && !!(0, i.G7)("synthetic_perf_vitals") && !0 === navigator.webdriver && r.test(navigator.userAgent)
      }
    },
    7909(e, t, a) {
      let n;
    ...
    1289(e, t, a) {
      ...
      var n = a(26316);
      let i = n.XC?.readyState === "interactive" || n.XC?.readyState === "complete" ? Promise.resolve() : new Promise(e => {
          n.XC?.addEventListener("DOMContentLoaded", () => {
            e()
          })
        }),
        r = n.XC?.readyState === "complete" ? Promise.resolve() : new Promise(e => {
    ...
    73537(e, t, a) {
      ...
      function r() {
        return new Set((0, i._$)().featureFlags)
      }
      let o = a(37337).X3 || function() {
        try {
    ...
    26316(e, t, a) {
      ...
      let n = "u" > typeof FORCE_SERVER_ENV && FORCE_SERVER_ENV,
        i = "u" < typeof document || n ? void 0 : document,
        r = "u" < typeof window || n ? void 0 : window,
        o = "u" < typeof history || n ? void 0 : history,
        c = "u" < typeof location || n ? {
          get pathname() {
            return (void 0) ?? ""
          },
          get origin() {
    ...
    37337(e, t, a) {
      ...
      function o() {
        return !!i || !n.XC || !!(n.XC.querySelector('react-app[data-ssr="true"]') || n.XC.querySelector('react-partial[data-ssr="true"][partial-name="repos-overview"]'))
      }
    },
    66953(e, t, a) {
      a.d(t, {
      ...
      function i() {
        return n.XC?.querySelector("projects-v2") ? "memex" : n.XC?.querySelector('react-partial[partial-name="repos-overview"]') ? "repos-overview" : n.XC?.querySelector("react-app")?.getAttribute("app-name")
      }
    },
    43626(e, t, a) {
      a.d(t, {
      ...
      let n = "font-weight: bold; font-size: 12px;";
      ...
      function r(e) {
        ...
        if (console.groupCollapsed(`%cstat%c ${a}${r?` ${r}`:""}`, "background: #1f6feb; color: #fff; padding: 2px 6px; border-radius: 3px; font-weight: bold; font-size: 11px;", n), e.webVitalTimings?.length)
          for (let t of e.webVitalTimings) {
            let a = void 0 !== t.lcp ? "LCP" : void 0 !== t.fcp ? "FCP" : void 0 !== t.ttfb ? "TTFB" : void 0 !== t.cls ? "CLS" : void 0 !== t.inp ? "INP" : void 0 !== t.hpc ? "HPC" : void 0 !== t.elementtiming ? "ElementTiming" : "Unknown",
              r = t.lcp ?? t.fcp ?? t.ttfb ?? t.cls ?? t.inp ?? t.hpc ?? t.elementtiming ?? 0;
            console.log(`%c${a}: %c${i(r)}`, n, r < 200 ? "color: #3fb950; font-weight: bold; font-size: 12px;" : r < 1e3 ? "color: #d29922; font-weight: bold; font-size: 12px;" : "color: #f85149; font-weight: bold; font-size: 12px;"), console.table({
              Name: {
                value: t.name ?? "\u2014"
              },
              CPU: {
              ...
              ...t.lcpBreakdown ? {
                "LCP TTFB": {
                  value: i(t.lcpBreakdown.ttfb)
                },
                "LCP FCP": {
                  value: i(t.lcpBreakdown.fcp)
                },
                "LCP Element Render Delay": {
                  value: i(t.lcpBreakdown.elementRenderDelay)
                }
              } : {}
            })
          }
        e.navigationTimings?.length && console.table(e.navigationTimings.map(e => ({
          ...
          "DOM Interactive": i(e.domInteractive),
          "DOM Complete": i(e.domComplete),
          "Load Event": i(e.loadEventEnd),
          Type: e.type ?? "\u2014"
          ...
          Name: e.name,
          Duration: i(e.duration),
          "Blocking Duration": i(e.blockingDuration)
    ...
    51189(e, t, a) {
      ...
      function h() {
        return void 0 === n && (n = !!(0, d.G7)("suppress_automated_browser_vitals") && (0, u.H)()), n
      }

      function R() {
        return void 0 === i && (i = !!(0, b.L)() || !h() && (P() || .5 > Math.random())), i
      }
      let v = [];

      function g(e) {
        return e || (0, m.f)() || "rails"
      }
      let S = g(),
        y = (0, r.g5)();
      ...
      function O(e, t = !1, a) {
        if (r.X3 || !0 === (0, d.G7)("browser_stats_disabled")) return;
        let n = a ?? +!!R();
        if (n < 0 || n > 1) throw RangeError("Sampling probability must be between 0 and 1");
        void 0 === e.timestamp && (e.timestamp = Date.now()), e.loggedIn = (0, f.M3)(), e.staff = P(), e.bundler = s.vV, e.ui = "vite-tss" === s.vV, e.app = S, e.ssr = String(y),
          function() {
            try {
          ...
          }() && (0, E.c)(e), Math.random() < n && v.push(e), t ? L() : A()
      }
      o.XC?.addEventListener(p.z.RENDER, () => {
        S = g(), y = (0, r.g5)()
      });
      let C = null,
        A = (0, l.n)(async function() {
          await c.K, null == C && (C = window.requestIdleCallback(L))
        }, 5e3);

      function L() {
        if (C = null, !v.length) return;
        let e = o.XC?.head?.querySelector('meta[name="browser-stats-url"]')?.content;
        if (e) {
          for (let n of function(e) {
            ...
            var t = e,
              a = `{"stats": [${n.join(",")}], "target": "${o.XC?.head?.querySelector('meta[name="ui-target"]')?.content||"full"}"}`;
            try {
      ...
      o.XC?.addEventListener("pagehide", L), o.XC?.addEventListener("visibilitychange", L)
    }
  }
]);
//# sourceMappingURL=34646-e68f26aaba7f2b0d-d5581b746080312e.js.map