          ...
          methods: {
            renderChildren: function() {
              ...
              if (this.$store.getters["widget/isRTL"] && o.classList.add("tawk-rtl"), this.$store.getters["browserData/mobileBrowserName"]) {
                ...
                var m = null === (g = this.$TawkJSAPI) || void 0 === g || null === (g = g.local_API) || void 0 === g || null === (g = g.customStyle) || void 0 === g ? void 0 : g.visibility;
                m && m.mobile && m.mobile.maximized && (m.mobile.maximized.paddingTop && (d = "".concat(m.mobile.maximized.paddingTop, "px")), m.mobile.maximized.paddingBottom && (h = "".concat(m.mobile.maximized.paddingBottom, "px")))
              }
