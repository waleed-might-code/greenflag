performance.mark("js-parse-end:18728-664614aa8ee76cdd.js");
"use strict";
(globalThis.webpackChunk_github_ui_github_ui = globalThis.webpackChunk_github_ui_github_ui || []).push([
  ["18728"], {
    13937(e, t, n) {
      ...
      function u(e, t) {
        !r && (r = new Map, "u" > typeof document && document.addEventListener("submit", d));
        let n = r.get(e) || [];
        r.set(e, [...n, t])
      }
      ...
      function d(e) {
        ...
        let i = function(e, t) {
          ...
          [a, c, u] = o();
        e.preventDefault(), h(n, t, i, a).then(async e => {
          if (e) {
            for (let e of s) await e(t);
            f(i).then(c, u).catch(() => {}).then(() => {
              for (let e of l) e(t)
            })
          } else t.submit()
        }, e => {
        ...
        let t = await window.fetch(e.url, {
          ...
          n = {
            ...
            get html() {
              var r, o;
              let e;
              return delete this.html, this.html = (r = document, o = this.text, (e = r.createElement("template")).innerHTML = o, r.importNode(e.content, !0)), this.html
            }
          };
    ...
    21744(e, t, n) {
      ...
      var i, o = window.document.documentElement,
        l = o.matches || o.webkitMatchesSelector || o.mozMatchesSelector || o.oMatchesSelector || o.msMatchesSelector;
      ...
      function d(e, t) {
        var n, r, i, o, l, s, a = (e = e.slice(0).concat(e.default)).length,
          c = t,
          d = [];
        do
          if (u.exec(""), (i = u.exec(c)) && (c = i[3], i[2] || !c)) {
            for (n = 0; n < a; n++)
              if (l = (s = e[n]).selector(i[1])) {
                for (r = d.length, o = !1; r--;)
                  if (d[r].index === s && d[r].key === l) {
                    o = !0;
                    break
                  } o || d.push({
                  index: s,
      ...
      r.prototype.logDefaultIndexUsed = function() {}, r.prototype.add = function(e, t) {
        var n, r, o, l, s, a, c, u, h = this.activeIndexes,
          f = this.selectors,
        ...
        if ("string" == typeof e) {
          for (r = 0, p[(n = {
              ...
              selector: e,
              data: t
            }).id] = n, c = d(this.indexes, e); r < c.length; r++) l = (u = c[r]).key, (s = function(e, t) {
            var n, r, i;
            for (n = 0, r = e.length; n < r; n++)
              if (i = e[n], t.isPrototypeOf(i)) return i
          }(h, o = u.index)) || ((s = Object.create(o)).map = new i, h.push(s)), o === this.indexes.default && this.logDefaultIndexUsed(n), (a = s.map.get(l)) || (a = [], s.map.set(l, a)), a.push(n);
          this.size++, f.push(e)
        }
      }, r.prototype.remove = function(e, t) {
        if ("string" == typeof e) {
          var n, r, i, o, l, s, a, c, u = this.activeIndexes,
            h = this.selectors = [],
          ...
          for (i = 0, n = d(this.indexes, e); i < n.length; i++)
            for (r = n[i], o = u.length; o--;)
              if (s = u[o], r.index.isPrototypeOf(s)) {
                if (a = s.map.get(r.key))
                  for (l = a.length; l--;)(c = a[l]).selector === e && (m || c.data === t) && (a.splice(l, 1), p[c.id] = !0);
                break
        ...
        for (t = 0, r = d.length; t < r; t++)
          for (n = 0, o = d[t], i = (l = this.matches(o)).length; n < i; n++) c[(a = l[n]).id] ? s = c[a.id] : (s = {
            id: a.id,
            selector: a.selector,
            data: a.data,
            elements: []
          }, c[a.id] = s, u.push(s)), s.elements.push(o);
        return u.sort(h)
      }, r.prototype.matches = function(e) {
        if (!e) return [];
        var t, n, r, i, o, l, s, a, c, u, d, f = this.activeIndexes,
          p = {},
          m = [];
        for (t = 0, i = f.length; t < i; t++)
          if (a = (s = f[t]).element(e)) {
            for (n = 0, o = a.length; n < o; n++)
              if (c = s.map.get(a[n]))
                for (r = 0, l = c.length; r < l; r++) !p[d = (u = c[r]).id] && this.matchesSelector(e, u.selector) && (p[d] = !0, m.push(u))
          } return m.sort(h)
      };
      var f = {},
        p = {},
      ...
      function S(e) {
        if (function(e) {
          ...
          if (t) {
            ...
            if (n.length) {
              y(e, "stopPropagation", w), y(e, "stopImmediatePropagation", E), A(e, k);
              for (var r = 0, i = n.length; r < i && !m.get(e); r++) {
                var o = n[r];
                b.set(e, o.node);
                for (var l = 0, s = o.observers.length; l < s && !g.get(e); l++) o.observers[l].data.call(o.node, e)
              }
              b.delete(e), A(e)
            }
          }
      ...
      function C(e, t, n) {
        var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
          ...
          l = o ? p : f,
          s = l[e];
        s || (s = new r, l[e] = s, document.addEventListener(e, S, o)), s.add(t, n)
      }
                ...
                if (t.offsetParent && t !== r.body) {
                  for (; t !== r.body;) {
                    ...
                    var n = i.getComputedStyle(t),
                      ...
                      l = n.overflowY,
                      s = n.overflowX;
                    if ("fixed" === o || "auto" === l || "auto" === s || "scroll" === l || "scroll" === s) break
                  }
                  return t
                }
              }
              for (var s = l(e), a = 0, c = 0; s;) {
    ...
    94571(e, t, n) {
      ...
      function a(e) {
        ...
        for (let n of c(t))
          if (e.type === n.type) {
            ...
            let o = t.getRootNode();
            if (o instanceof ShadowRoot && i.has(o.host) && o.host.matches(n.tag)) {
              let t = o.host;
      ...
      function u(e) {
        for (let t of c(e)) e.addEventListener(t.type, a)
      }
      ...
      function b(e, t) {
        ...
        for (let i of (t || (t = L(n, p)), t)) {
          ...
          }), Object.defineProperty(e, i, o), i in e && !e.hasAttribute(n) && o.set.call(e, t)
        }
      }
      let v = new Map,
        y = new Promise(e => {
        ...
        cancelAnimationFrame(k.get(e) || 0), k.set(e, requestAnimationFrame(() => {
          for (let t of v.keys()) {
            ...
            if (customElements.get(t) || n) {
              ...
              for (let e of v.get(t) || []) i(t).then(e);
              v.delete(t), k.delete(e)
            }
          }
        }))
      }
      ...
      function S(e, t) {
        for (let [n, r] of("string" == typeof e && t && (e = {
            [e]: t
          }), Object.entries(e))) v.has(n) || v.set(n, new Set), v.get(n).add(r);
        C(document)
      }
      ...
      class T {
        constructor(e, t) {
          ...
          Object.defineProperty(e, "observedAttributes", {
            ...
            function(e) {
              ...
              Object.defineProperty(e, "observedAttributes", {
                configurable: !0,
                get: () => [...L(e.prototype, p)].map(r).concat(t),
                set(e) {
                  t = e
                }
              })
        ...
        connectedCallback(e, t) {
          ...
          (b(e), i.add(e), e.shadowRoot && (s(r = e.shadowRoot), l(r)), s(e), l(e.ownerDocument), t?.call(e), e.shadowRoot) && (s(n = e.shadowRoot), l(n), C(e.shadowRoot))
        }
        disconnectedCallback(e, t) {
          t?.call(e)
        }
        attributeChangedCallback(e, t, n, r, i) {
          b(e), "data-catalyst" !== t && i && i.call(e, t, n, r)
        }
      }
    ...
    74057(e, t, n) {
      ...
      function o(e) {
        let t = Array.from(e.querySelectorAll("[autofocus]")).filter(s)[0];
      ...
      function l(e) {
        ...
        t instanceof Element && ("Escape" === e.key || "Esc" === e.key ? (d(t, !1), e.stopPropagation()) : "Tab" === e.key && function(e) {
          ...
          if (!t) return;
          e.preventDefault();
          let n = Array.from(t.querySelectorAll("*")).filter(s);
          if (0 === n.length) return;
      ...
      function c(e) {
        ...
        t && t.hasAttribute("open") && (a(t) || (e.preventDefault(), e.stopPropagation()))
      }
      ...
      function u(e) {
        ...
        if (n instanceof g)
          if (t.hasAttribute("open")) {
            ...
            }), o(n), t.addEventListener("keydown", l)
          } else {
            var r, i;
            let e;
            for (let e of n.querySelectorAll("form")) e.reset();
            let o = (r = t, i = n, (e = m.get(i)) && e.activeElement instanceof HTMLElement ? e.activeElement : r.querySelector("summary"));
            o && o.focus(), t.removeEventListener("keydown", l)
          }
      }

      function d(e, t) {
        t !== e.hasAttribute("open") && (t ? e.setAttribute("open", "") : a(e) && e.removeAttribute("open"))
      }
      ...
      function h(e) {
        ...
        }), r.setAttribute("src", i), p(t))
      }

      function f(e, t, n) {
        p(e), t && e.addEventListener("toggle", h, {
          once: !0
        }), t && n && e.addEventListener("mouseover", h, {
          once: !0
        })
      }
      ...
      class g extends HTMLElement {
        ...
        connectedCallback() {
          ...
          n && (n.hasAttribute("role") || n.setAttribute("role", "button"), n.addEventListener("click", c, {
            capture: !0
          })), t.addEventListener("toggle", u), e.details = t, f(t, this.src, this.preload)
        }
        disconnectedCallback() {
          ...
          if (!t) return;
          t.removeEventListener("toggle", u), p(t);
          let n = t.querySelector("summary");
    ...
    50515(e, t, n) {
      ...
      class i {
        ...
        insert(e) {
          ...
          for (let n = 0; n < e.length; n += 1) {
            let o = e[n],
              l = t.get(o);
            if (n === e.length - 1) return l instanceof i && (t.delete(l), l = null), l || (l = new r(t), t.children[o] = l), l;
            l instanceof r && (l = null), l || (l = new i(t), t.children[o] = l), t = l
          }
          return t
        }
        delete(e) {
      ...
      function a(e, t = navigator.platform) {
        ...
        for (let [e, t] of [u, h, f, p].entries()) t && g.push(c[e]);
        if (!c.includes(m)) {
          let e = g.includes("Alt") && d.test(t) && null != (n = o[m]) ? n : m,
            a = g.includes("Shift") && d.test(t) && null != (r = l[e]) ? r : e,
            c = null != (i = s[a]) ? i : a;
          g.push(c)
        }
        return g.join("+")
      ...
      function u(e, t) {
        let n, r, i;
        {
          var o, l, s, a = (o = e, l = t, r = "u" < typeof window ? void 0 : window, i = d.test(null != (s = null != l ? l : null == r ? void 0 : r.navigator.platform) ? s : "") ? "Meta" : "Control", n = o.replace("Mod", i));
          let c = a.split("+").pop(),
            u = [];
          for (let e of ["Control", "Alt", "Meta", "Shift"]) a.includes(e) && u.push(e);
          return c && u.push(c), u.join("+")
        }
      }
      let d = /Mac|iPod|iPhone|iPad/i;
      class h {
        constructor({
          onReset: e
        } = {}) {
        ...
        reset() {
          var e;
          this.killTimer(), this._path = [], null == (e = this.onReset) || e.call(this)
        }
        killTimer() {
          null != this.timer && window.clearTimeout(this.timer), this.timer = null
        }
        startTimer() {
          this.killTimer(), this.timer = window.setTimeout(() => this.reset(), h.CHORD_TIMEOUT)
        }
      }

      function f(e) {
        return e.split(" ").map(e => u(e)).join(" ")
      }
      ...
      function y(e) {
        ...
        if (v.registerKeypress(e), b = t, t instanceof r) {
          let r, i = e.target,
            o = !1,
            l = p(i);
          ...
          if (r && o) {
            var n;
            let t;
            n = r, t = new CustomEvent("hotkey-fire", {
              cancelable: !0,
              detail: {
                path: v.path
              }
            }), n.dispatchEvent(t) && (p(n) ? n.focus() : n.click()), e.preventDefault()
          }
          v.reset()
        }
      }
      ...
      function w(e, t) {
        0 === Object.keys(m.children).length && document.addEventListener("keydown", y);
        let n = (function(e) {
          let t = [],
            n = [""],
            r = !1;
          ...
          return t.push(n), t.map(e => e.map(e => u(e)).filter(e => "" !== e)).filter(e => e.length > 0)
        })(t || e.getAttribute("data-hotkey") || "").map(t => m.insert(t).add(e));
        g.set(e, n)
      }
      ...
      function E(e) {
        ...
        0 === Object.keys(m.children).length && document.removeEventListener("keydown", y)
      }
    },
    97088(e, t, n) {
      n.d(t, {
...
//# sourceMappingURL=18728-664614aa8ee76cdd-29967404cc3603f6.js.map