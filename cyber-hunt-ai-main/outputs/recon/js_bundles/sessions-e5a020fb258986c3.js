performance.mark("js-parse-end:sessions-e5a020fb258986c3.js");
"use strict";
(globalThis.webpackChunk_github_ui_github_ui = globalThis.webpackChunk_github_ui_github_ui || []).push([
  ["47349"], {
    40845(e, t, n) {
      ...
      function s(e) {
        ...
        e && (t = new o.TemplateInstance(document.querySelector("template.js-flash-template"), {
          ...
          message: e
        }), n = document.importNode(t, !0), (r = document.querySelector("#js-flash-container")) && (u(), r.appendChild(n))), l()
      }
      ...
      async function m(e, t, n, o) {
        try {
          var r;
          await (r = e.getAttribute("data-poll-url"), async function e(a) {
            let u, l, c, m;
            if (o && o()) return;
            ...
            try {
              ...
              if (n.ok) {
                let e = await n.json();
                f = e.status, u = e.token, l = e.sign_in_method
              } else f = "STATUS_ERROR"
            } catch {
              f = "STATUS_ERROR"
            }
            switch (f) {
              case "STATUS_APPROVED":
                var h, p;
                return t ? t() : (h = u, p = l, void((m = h ? new URL(`password_reset/${encodeURIComponent(h)}`, window.location.origin) : new URL("", window.location.href)).searchParams.set("redirect", "true"), p && m.searchParams.set("sign_in_method", p), window.location.assign(m)));
              case "STATUS_EXPIRED":
                return c = d("timeout-flash"), n ? n(c) : s(c);
              case "STATUS_ACTIVE":
              case "STATUS_ERROR":
              case "STATUS_UNKNOWN":
                break;
              ...
              default:
                return c = d("error-flash"), n ? n(c) : s(c)
            }
            await new Promise(e => setTimeout(e, 3e3)), e(a)
          }(0))
        } catch {
          return s(d("error-flash"))
        }
      }(0, r.lB)(".js-poll-github-mobile-two-factor-authenticate", function(e) {
        m(e)
      }), (0, r.lB)(".js-poll-github-mobile-verified-device-authenticate", function(e) {
        m(e)
      }), (0, r.lB)(".js-poll-github-mobile-two-factor-password-reset-authenticate", function(e) {
        m(e)
      })
    },
    68459(e, t, n) {
      ...
      var i = n(21744),
        ...
        l = n(46131),
        c = n(14915);
      (0, u.JW)(".js-send-auth-code", async (e, t) => {
        let n;
      ...
      }), (0, u.JW)(".js-two-factor-set-sms-fallback", async (e, t) => {
        let n;
        try {
          n = await t.text()
        } catch (r) {
      ...
      }), (0, a.eC)(".js-verification-code-input-auto-submit", function(e) {
        let t = e.currentTarget,
          n = t.pattern || "[0-9]{6}";
        RegExp(`^(${n})$`).test(t.value) && (0, l.k_)(t.form)
      ...
      function d() {
        for (let e of document.querySelectorAll(".more-options-two-factor")) {
          let t = s.get(e);
          t?.timeline && t.timeline.kill(), s.delete(e)
        }
      }
      ...
      function f() {
        ...
        let o = document.querySelector(".two-factor-alternatives-body"),
          ...
          a = document.querySelectorAll(".more-options-two-factor .octicon-triangle-down"),
          u = document.querySelector(".two-factor-alternatives-divider");
        o && r.length && (n.timeline?.kill(), n.timeline = c.os.timeline(), n.isOpen ? n.timeline.to(u, {
          display: "none",
          opacity: 0,
          y: -5,
          duration: .25
      ...
      async function g() {
        ...
        if (t && o && "supported" === e) {
          ...
          if (n && n.addEventListener("webauthn-get-prompt", () => {
            ...
            t.querySelector(".js-conditional-webauthn-response").value = JSON.stringify(r.toJSON()), (0, l.k_)(t)
          } else {
            let n = JSON.parse(e),
              o = (0, p.d5)(n);
            o.signal = y.signal;
            let r = await (0, p.Jt)(o);
            t.querySelector(".js-conditional-webauthn-response").value = JSON.stringify(r), (0, l.k_)(t)
          }
        }
      }(0, r.lB)(".js-webauthn-support", {
        constructor: HTMLInputElement,
        add(e) {
          (0, l.m$)(e, (0, h.K)())
        }
      }), (0, r.lB)(".js-webauthn-iuvpaa-support", {
        constructor: HTMLInputElement,
        async add(e) {
          (0, l.m$)(e, await (0, h.e)())
        }
      ...
      }), (0, r.lB)(".js-conditional-webauthn-placeholder", function() {
        g()
      });
      var w = n(58209);
      ...
      function E(e) {
        ...
        let r = e.value,
          ...
          u = document.querySelector(".js-webauthn-hint-emu-control"),
          l = document.querySelector("#forgot-password");
        !(!(0, w.kA)() && "true" !== o.getAttribute("disable-emu-sso") && r.includes("_")) || r.includes("@") || ["pj_nitin", "up_the_irons"].includes(r) || r.endsWith("_admin") || o.getAttribute("development") && r.endsWith("_fab") ? (n.removeAttribute("disabled"), o.value = o.getAttribute("data-signin-label") || " ", i?.removeAttribute("hidden"), a?.removeAttribute("hidden"), u?.removeAttribute("hidden"), l?.removeAttribute("hidden")) : (n.setAttribute("disabled", "true"), o.value = o.getAttribute("data-sso-label") || " ", i?.setAttribute("hidden", "true"), a?.setAttribute("hidden", "true"), u?.setAttribute("hidden", "true"), l?.setAttribute("hidden", "true"))
      }(0, r.lB)(".js-login-field", {
        constructor: HTMLInputElement,
        add(e) {
          E(e), e.addEventListener("input", function() {
            E(e)
          })
        }
      })
    ...
    17005(e, t, n) {
      ...
      function i(e, t, n = null, o = !1, r = "lax") {
        ...
        let u = "https:" === location.protocol ? "; secure" : "",
          l = n ? `; expires=${n}` : "";
        !1 === o && (a = `.${a}`);
        try {
          document.cookie = `${e}=${t}; path=/; domain=${a}${l}${u}; samesite=${r}`
        } catch {}
      }
    ...
    381(e, t, n) {
      ...
      function l(e) {
        let t = {};
        return void 0 !== e && (t["X-Fetch-Nonce-To-Validate"] = e), void 0 === e ? t[r] = u() : i.has(e) ? t[r] = e : t[r] = Array.from(i).join(","), t
      }
    ...
    58209(e, t, n) {
      ...
      let i = (0, o.A)(function() {
          return r.XC?.head?.querySelector('meta[name="runtime-environment"]')?.content || ""
        }),
        a = (0, o.A)(function() {
          return "enterprise" === i()
        }),
    ...
    26316(e, t, n) {
      ...
      let o = "u" > typeof FORCE_SERVER_ENV && FORCE_SERVER_ENV,
        r = "u" < typeof document || o ? void 0 : document,
        i = "u" < typeof window || o ? void 0 : window,
        a = "u" < typeof history || o ? void 0 : history,
        u = "u" < typeof location || o ? {
          get pathname() {
            return (void 0) ?? ""
          },
          get origin() {
    ...
    37337(e, t, n) {
      ...
      function a() {
        return !!r || !o.XC || !!(o.XC.querySelector('react-app[data-ssr="true"]') || o.XC.querySelector('react-partial[data-ssr="true"][partial-name="repos-overview"]'))
      }
    },
    95869(e, t, n) {
      n.d(t, {
  ...
  function(e) {
    e.O(0, ["46752", "93308", "96232"], function() {
      return e(e.s = 68459)
    }), e.O()
  }
]);
//# sourceMappingURL=sessions-e5a020fb258986c3-00dc4a95bde541e6.js.map