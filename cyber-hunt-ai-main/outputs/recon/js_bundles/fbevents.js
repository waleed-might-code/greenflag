          ...
          var K = (function() {
            ...
            return N(o, [{
              ...
              value: function(n) {
                ...
                return i(n.eventData, n.customData || {}, a, n.pixelId), r && T(D(r), function(e) {
                  if (a.containsKey(e)) {
        ...
        return (function() {
          ...
          var e = a.getFbeventsModules("SignalsFBEventsTyped"),
            ...
            r = t.objectWithFields({
              ...
              dublinCorePropertyNames: t.arrayOf(t.lowercaseString()),
              twitterCardPropertyNames: t.arrayOf(t.lowercaseString())
            }),
            i = t.objectWithFields({
              ...
              dublinCoreTypeHints: t.arrayOf(t.lowercaseString()),
              twitterCardTypeNames: t.arrayOf(t.lowercaseString()),
              twitterCardTypeHints: t.arrayOf(t.lowercaseString()),
      ...
      return (function(e, t, n, r) {
        ...
        return (function() {
          ...
          function f(e, o) {
            ...
            var f = i.trigger(String(e.id), e.customData || {}, e.eventName);
            f && s(f, function(t) {
              t && s(u(t), function(r) {
                e.customParams = e.customParams || new n, e.customParams.append(r, t[r])
              })
                ...
                switch (r.extractorType) {
                  ...
                  case "CONSTANT_VALUE":
                    var f = r.extractorConfig,
                      ...
                      C = f.value;
                    return {
                      extractorID: r.id, jsonLD: Pe($e, h, C)
                    };
                  case "URI":
                    ...
                    return {
                      extractorID: r.id, jsonLD: Pe($e, v, R)
                    };
                  default:
            ...
            function we(e) {
              ...
              switch (e.extractor_type) {
                case "CSS":
                  ...
                  return {
                    domainURI: new ue(e.domain_uri), eventType: e.event_type, extractorConfig: (t = r, {
                    ...
                    }), extractorType: "CSS", id: g()(e.id), ruleId: (n = e.event_rule) === null || n === void 0 ? void 0 : n.id
                  };
                case "CONSTANT_VALUE":
                  var o;
                  if (e.extractor_config == null) throw new Error("extractor_config must be set");
                  ...
                  return {
                    domainURI: new ue(e.domain_uri), eventType: e.event_type, extractorConfig: Ae(a), extractorType: "CONSTANT_VALUE", id: g()(e.id), ruleId: (o = e.event_rule) === null || o === void 0 ? void 0 : o.id
                  };
                case "URI":
                  var i;
                  if (e.extractor_config == null) throw new Error("extractor_config must be set");
                  ...
                  return {
                    domainURI: new ue(e.domain_uri), eventType: e.event_type, extractorConfig: Fe(l), extractorType: "URI", id: g()(e.id), ruleId: (i = e.event_rule) === null || i === void 0 ? void 0 : i.id
                  };
                default:
                  var s;
                  return {
                    domainURI: new ue(e.domain_uri), eventType: e.event_type, extractorType: e.extractor_type, id: g()(e.id), ruleId: (s = e.event_rule) === null || s === void 0 ? void 0 : s.id
                  }
              }
            }
              ...
              if (!(f.getItem(p) || !s || !(e.data && (r === "FACEBOOK_IWL_BOOTSTRAP" || r === "FACEBOOK_IWL_CONFIRM_DOMAIN")))) {
                ...
                switch (r) {
                  ...
                  case "FACEBOOK_IWL_CONFIRM_DOMAIN": {
                    e.source.postMessage("FACEBOOK_IWL_CONFIRM_DOMAIN_ACK", e.origin), y(a, n);
                    break
                  }
                }
              }
          ...
          function Be(e) {
            ...
            switch (e) {
              ...
              case "autoConfig": {
                ...
                typeof p == "string" ? xe.callMethod([_, p, "AutomaticSetup"]) : p === void 0 ? xe.disableAutoConfig = _ === "optOut" : we("pixel_id", p, "set", o);
                break
              }
              case "smartSetup": {
                var f = n[0],
                ...
                typeof h == "string" ? xe.callMethod([y, h, "SmartSetup"]) : h === void 0 ? xe.disableSmartSetup = y === "optOut" : we("pixel_id", h, "set", o);
                break
              }
              case "firstPartyCookies": {
                ...
                typeof v == "string" ? xe.callMethod([R, v, "FirstPartyCookies"]) : v === void 0 ? xe.disableFirstPartyCookies = R === "optOut" : we("pixel_id", v, "set", o);
                break
              }
              case "experiments": {
              ...
              case "parallelfire": {
                var B = n[0],
                  W = n[1];
                xe.pluginConfig.set(B, "parallelfire", {
                  target: W
                });
                break
              }
              case "openbridge": {
                var q = n[0],
                  U = n[1];
                q !== null && U !== null && typeof q == "string" && typeof U == "string" && (xe.callMethod(["optIn", q, "OpenBridge"]), xe.pluginConfig.set(q, "openbridge", {
                  endpoints: [{
                    endpoint: U
                  }]
                }));
              ...
              case "trackSingleOnly": {
                ...
                K.error && he(K.error), K.warnings && K.warnings.forEach(function(e) {
                  he(e)
