performance.mark("js-parse-end:51210-3abb7238871a5b29.js");
"use strict";
    ...
    9841(t, e, i) {
      ...
      class n {
        ...
        indicateDefaultOption() {
          var t;
          this.defaultFirstOption && (null == (t = Array.from(this.list.querySelectorAll('[role="option"]:not([aria-disabled="true"])')).filter(l)[0]) || t.setAttribute("data-combobox-option-default", "true"))
        }
        navigate(t = 1) {
          let e = Array.from(this.list.querySelectorAll('[aria-selected="true"]')).filter(l)[0],
            i = Array.from(this.list.querySelectorAll('[role="option"]')).filter(l),
            n = i.indexOf(e);
      ...
      class u extends EventTarget {
        ...
        for (t) {
          let e = h.get(t);
          return e || (e = new u(t), h.set(t, e)), e
        }
        constructor(t) {
          super(), this.#s = new WeakRef(t), this.#o.style.position = "absolute", this.#o.style.pointerEvents = "none", this.#o.setAttribute("aria-hidden", "true"), this.#o.appendChild(this.#l), this.#l.style.pointerEvents = "none", this.#l.style.userSelect = "none", this.#l.style.overflow = "hidden", this.#l.style.display = "block", this.#l.style.visibility = "hidden", t instanceof HTMLTextAreaElement ? (this.#l.style.whiteSpace = "pre-wrap", this.#l.style.wordWrap = "break-word") : (this.#l.style.whiteSpace = "nowrap", this.#l.style.display = "table-cell", this.#l.style.verticalAlign = "middle"), t.after(this.#o), this.#e(), this.#r(), this.#t.observe(t, {
        ...
        #m() {
          this.#c(t => {
            ...
            this.#l.style.height = e.height, this.#l.style.width = e.width, t.clientHeight !== this.#l.clientHeight && (this.#l.style.height = `calc(${e.height} + ${t.clientHeight-this.#l.clientHeight}px)`), t.clientWidth !== this.#l.clientWidth && (this.#l.style.width = `calc(${e.width} + ${t.clientWidth-this.#l.clientWidth}px)`);
            let i = t.getBoundingClientRect(),
              n = this.#l.getBoundingClientRect();
            this.#d = this.#d + i.left - n.left, this.#p = this.#p + i.top - n.top, this.#l.style.transform = `translate(${this.#d}px, ${this.#p}px)`, this.#l.scrollTop = t.scrollTop, this.#l.scrollLeft = t.scrollLeft, this.dispatchEvent(new a)
          })
        }
        #f = !1;
        #n() {
        ...
        #e() {
          this.#c(t => {
            let e = window.getComputedStyle(t);
            for (let t of c) this.#l.style[t] = e[t];
            this.#n()
          })
        }
        #r() {
      ...
      let c = ["direction", "writingMode", "unicodeBidi", "textOrientation", "boxSizing", "borderTopWidth", "borderRightWidth", "borderBottomWidth", "borderLeftWidth", "borderStyle", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "fontStyle", "fontVariant", "fontWeight", "fontStretch", "fontSize", "fontSizeAdjust", "lineHeight", "fontFamily", "textAlign", "textTransform", "textIndent", "textDecoration", "letterSpacing", "wordSpacing", "tabSize", "MozTabSize"];
      class d {
        #v;
        #g;
        #b;
      ...
      class m {
        ...
        positionMenu(t, e) {
          ...
          if (0 !== l.left || 0 !== l.top) {
            ...
            t.style.left = e.left ? `calc(${e.left} + ${l.left}px)` : `${l.left}px`, t.style.top = e.top ? `calc(${e.top} + ${l.top}px)` : `${l.top}px`
          }
        }
        deactivate() {
          let t = this.menu;
        ...
        onCommit({
          ...
          let l = null != (e = this.expander.getAttribute("suffix")) ? e : " ";
          o.continue && (l = "");
          let r = `${o.value}${l}`;
          ...
          for (let {
            ...
            let s = function(t, e, i, {
              ...
              if (n) {
                ...
                if (" " === t[l + 1] && i >= l + e.length + 1 || t.lastIndexOf("\n", i - 1) > l || t.lastIndexOf(".", i - 1) > l) return
              } else if (t.lastIndexOf(" ", i - 1) > l) return;
              let a = t[l - 1];
              if (!a || r.test(a)) return {
...
//# sourceMappingURL=51210-3abb7238871a5b29-dae9949fdb1e20d0.js.map